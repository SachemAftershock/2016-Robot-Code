...
public class LedStrip {
	...
	public static void flash(int duration) {
		setColor(Colors.eBlue);
		Timer.delay(duration);
		setColor(Colors.eGreen);
		Timer.delay(duration);
		setColor(Colors.eOrange);
		Timer.delay(duration);
		setColor(Colors.ePink);
		Timer.delay(duration);
		setColor(Colors.ePurple);
		Timer.delay(duration);
		setColor(Colors.eRed);
		Timer.delay(duration);
		setColor(Colors.eTeal);
		Timer.delay(duration);
		setColor(Colors.eWhite);
		Timer.delay(duration);
